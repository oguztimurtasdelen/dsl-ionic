...
import { IonContent, IonGrid, IonRow, IonCol, IonItem, IonLabel, IonInput, IonList, IonCheckbox, IonButton, IonDatetime, IonHeader, IonToolbar, IonTitle, IonProgressBar } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonToolbar, IonRow, IonButton, IonCheckbox, IonList, IonInput, IonLabel, IonItem, IonGrid, IonCol, IonContent, CommonModule, FormsModule, ReactiveFormsModule, IonDatetime, IonHeader, IonTitle, IonToolbar, IonProgressBar]
})
